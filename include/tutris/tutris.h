...
namespace ns_Tutris
{
    ...
    const tutris_color COLOR_RED (0xFF, 0x31, 0x31);
    const tutris_color COLOR_DARKRED (0x71, 0x15, 0x15);
    const tutris_color COLOR_GREEN(0x1C, 0xE0, 0x33);
    const tutris_color COLOR_DARKGREEN(0x12, 0x61, 0x13);
    const tutris_color COLOR_BLUE(0x3F, 0x39, 0xFF);
    const tutris_color COLOR_DARKBLUE(0x15, 0x19, 0x71);
    const tutris_color COLOR_BLUEGREY(0xE3, 0xE6, 0xFF);
    //const block_color COLOR_BLUE(0x00, 0x14, 0x34);
    const tutris_color COLOR_YELLOW(0xFB, 0xFF, 0x37);
    const tutris_color COLOR_DARKYELLOW(0x5D, 0x60, 0x0E);
    const tutris_color COLOR_WHITE(0xFF, 0xFF, 0xFF);
    const tutris_color COLOR_BLACK(0x00, 0x00, 0x00);
    const tutris_color COLOR_DARKGREY(0x5E, 0x5E, 0x5E);
    const tutris_color COLOR_LIGHTGREY(0x7D, 0x7D, 0x7D);
