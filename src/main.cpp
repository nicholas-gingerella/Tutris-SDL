...
Game* game_instance = new Game(SCREEN_WIDTH/2 - ((Tutris::FIELD_WIDTH/2)*Tutris::BLOCK_SIZE_PIXEL), 100, Tutris::FIELD_WIDTH, Tutris::FIELD_HEIGHT);
        ...
        switch(tutris_state)
        {
            case game_state::title:
            {
                if (!on_title_screen)
                {
                    ...
                    game_instance = new Game(SCREEN_WIDTH/2 - ((Tutris::FIELD_WIDTH/2)*Tutris::BLOCK_SIZE_PIXEL), 100, Tutris::FIELD_WIDTH, Tutris::FIELD_HEIGHT);
                    elapsed_ms = 0;
                    score = 0;
                    updateGameScoreText(renderer, score);
